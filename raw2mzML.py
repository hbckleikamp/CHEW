...
kws_filename=datetime.now().strftime("%y_%m_%d_%H_%M_%S")+"_raw2mzML.CHEW_params" #the basename needs to be changed manually per script, since inspect only works form CLI
